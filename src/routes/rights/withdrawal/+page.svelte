<div class="flex items-center">
	<h1 class="text-lg font-semibold md:text-2xl">Right of Withdrawal</h1>
</div>
<p>
	...
	dolor sit amet, consetetur sadipscing elitr, At accusam aliquyam diam diam dolore dolores duo
	eirmod eos erat, et nonumy sed tempor et et invidunt justo labore Stet clita ea et gubergren, kasd
	magna no rebum. sanctus sea sed takimata ut vero voluptua. est Lorem ipsum dolor sit amet. Lorem
